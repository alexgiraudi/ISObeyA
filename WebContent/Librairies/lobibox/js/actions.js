        ...
        (function () {
            ...
            $('#AboutInfo').click(function () {
                Lobibox.notify('info', {
                    ...
                    msg: 'IS Operations Obeya For ISOP Version 3.3.2'
                });
            });
            $('#basicInfo').click(function () {
                Lobibox.notify('info', {
                    msg: 'This message just indicates a normal information.'
                });
            });
            $('#basicWarning').click(function () {
                Lobibox.notify('warning', {
                    msg: 'This message indicates a warning information.'
                });
            });
            $('#basicError').click(function () {
                Lobibox.notify('error', {
                    msg: 'This message indicates an error information.'
                });
            });
            $('#basicSuccess').click(function () {
                Lobibox.notify('success', {
                    msg: 'This message indicates a success information.'
                });
            });
        })();
        //------------------------------------------------------------------------------
